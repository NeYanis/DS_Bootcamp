...
def main():
    if len(sys.argv) != 2:
        Research(sys.argv[1]).send_log_message("The report hasn’t been created due to an error")
    ...
    try:
        ...
        res.send_log_message("The report has been successfully created")
    except Exception:
        res.send_log_message("The report hasn’t been created due to an error")
